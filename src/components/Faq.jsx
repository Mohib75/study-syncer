				...
				<div className='container flex flex-col justify-center px-4 py-8 mx-auto md:p-8'>
					<div className='space-y-4'>
						...
						<details className='w-full border rounded-lg cursor-pointer'>
							...
							<p className='px-4 py-6 pt-0 ml-4 -mt-4'>
								Yes, you can. Go to the pending assignment section and click give mark button. Fill out the required form for giving
								mark then click submit.
							</p>
						</details>
						<details className='w-full border rounded-lg cursor-pointer'>
							<summary className='px-4 py-6 focus:outline-none'>Can i edit any assignment?</summary>
							<p className='px-4 py-6 pt-0 ml-4 -mt-4'>
								Yes, you can edit any assignment. Go to the assignment section then choose any of your prefer assignment, there is a
								edit button then click it. Fil out required information then click Update.
							</p>
						</details>
					</div>
				</div>
